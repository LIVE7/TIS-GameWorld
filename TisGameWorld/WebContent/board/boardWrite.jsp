...
<div class="container">
	...
	enctype: multipart/form-data  -->
			<form name="bf" id="bf" role="form" action="boardInsert.do" method="POST"
				enctype="multipart/form-data">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td style="width: 80%"><input type="text" name="name"
							id="name" class="form-control" value="<%=member.getMember_name()%>" readonly="readonly"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="width: 80%">
							<div class="col-md-5">
								<input type="password" name="pwd" id="bpwd" class="form-control" value="<%=member.getMember_pwd()%>" readonly="readonly">
							</div>
						</td>
					</tr>
					<tr>
